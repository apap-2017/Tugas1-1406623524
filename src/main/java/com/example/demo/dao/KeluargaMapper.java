...
public interface KeluargaMapper {
	...
	@Select("SELECT p.nama, p.nik as nik, p.jenis_kelamin as jenis_kelamin, p.tempat_lahir as tempat_lahir, p.tanggal_lahir as tanggal_lahir, "
			+ "p.agama as agama, p.pekerjaan as pekerjaan, p.status_perkawinan as status_perkawinan, p.status_dalam_keluarga as status_dalam_keluarga, p.is_wni as is_wni "
